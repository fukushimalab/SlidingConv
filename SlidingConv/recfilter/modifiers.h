...
void replace_function(Halide::Internal::Function& F, Halide::Internal::Function _F);
Halide::Internal::Function create_function_same_group(Halide::Internal::Function F);
...
Halide::Expr substitute_func_with_args_call
(
	std::string func_name,
	Halide::Var split_x,
	Halide::Internal::Function new_func,
	std::vector<Halide::Expr> new_func_call_args,
