...
bool operator==(const FuncType& a, const FuncType& b);
bool operator==(const VarTag& a, const VarTag& b);
bool operator!=(const FuncTag& a, const FuncTag& b);
bool operator!=(const FuncType& a, const FuncType& b);
bool operator!=(const VarTag& a, const VarTag& b);
bool operator==(const FuncTag& a, const FunctionTag& b);
bool operator==(const FuncType& a, const FunctionType& b);
...
std::ostream& operator<<(std::ostream& s, const FunctionType& f);
std::ostream& operator<<(std::ostream& s, const VariableTag& v);
std::ostream& operator<<(std::ostream& s, const FuncTag& f);
std::ostream& operator<<(std::ostream& s, const FuncType& f);
...
{
public:
	FuncType(void) : type(NONE) {}
	FuncType(const FuncType& t) : type(t.type) {}
	FuncType(const FunctionType& t) : type(t) {}
	FuncType& operator=(const FuncType& t) { type = t.type; return *this; }
	FuncType& operator=(const FunctionType& t) { type = t; return *this; }
	int as_integer(void) const { return static_cast<int>(type); }
private:
	FunctionType type;
};
...
struct RecFilterContents
{
	...
	/** For Custom Recfilter */
	std::vector<std::vector<Halide::Expr>> feedfwd_coeff_expr;
	std::vector<std::vector<Halide::Expr>> feedback_coeff_expr;
